...
PearsonGL.External.masterJS = (function() {
  ...
  ********************************************************************************/
  ...
  var ts = { // test functions only
    ...
    sliderVal:function(val,name,desmos){return PearsonGL.External.rootJS.shared_label_valueOnly((desmos!==undefined)?{'value':val,'name':name,'desmos':desmos,'log':log}:val);}
  };
